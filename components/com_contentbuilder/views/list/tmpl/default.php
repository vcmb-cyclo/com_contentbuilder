...
if($this->export_xls):
    ...
    <div class="mb-3" style="float: right; text-align: right;">
        <a href="<?php echo JRoute::_('index.php?option=com_contentbuilder&controller=export&id='.CBRequest::getInt('id',0).'&type=xls&format=raw&tmpl=component'); ?>"><i class="fa fa-solid fa-2x fa-file-excel"></i></a>
    </div>
            ...
            <tr>
                <td>
					...
					if ($state_allowed && count($this->states)) {
                        ...
                        <button style="margin-bottom: 0.25rem;" class="button btn btn-sm btn-primary cbButton cbSearchButton" onclick="contentbuilder_state();"><?php echo JText::_('COM_CONTENTBUILDER_SET'); ?></button>
						<?php
					}
					?>
					<?php
					if ($publish_allowed) {
                        ...
                        <button style="margin-bottom: 0.25rem;" class="button btn btn-sm btn-primary cbButton cbSearchButton" onclick="contentbuilder_publish();"><?php echo JText::_('COM_CONTENTBUILDER_SET'); ?></button>
						<?php
					}
					?>
					<?php
					if ($language_allowed) {
                        ...
                        <button style="margin-bottom: 0.25rem;" class="button btn btn-sm btn-primary cbButton cbSearchButton" onclick="contentbuilder_language();"><?php echo JText::_('COM_CONTENTBUILDER_SET'); ?></button>
						<?php
					}
					?>
                </td>
            ...
            <tr>
				...
				if($this->select_column && ( $delete_allowed || $state_allowed || $publish_allowed ) ){
                    ...
                    <th class="sectiontableheader hidden-phone" width="20">
                        <input class="contentbuilder_select_all form-check-input" type="checkbox" onclick="contentbuilder_selectAll(this);"/>
                    </th>
					<?php
				}
			...
			for ($i=0; $i < $n; $i++)
			{
                ...
                <tr class="<?php echo "row$k"; ?>">
					...
					if($this->edit_button && $edit_allowed){
						?>
                        <td>
                            <a href="<?php echo $edit_link; ?>"><img src="<?php Juri::root(true)?>components/com_contentbuilder/images/edit.png" border="0" width="18" height="18"/></a>
                        </td>
						<?php
					}
					?>
