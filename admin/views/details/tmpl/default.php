...
<?php if ($this->author)
    Factory::getContainer()->get(ApplicationInterface::class)->getDocument()->setMetaData('author', $this->author); ?>
<?php if ($this->robots)
    Factory::getContainer()->get(ApplicationInterface::class)->getDocument()->setMetaData('robots', $this->robots); ?>
<?php if ($this->rights)
    Factory::getContainer()->get(ApplicationInterface::class)->getDocument()->setMetaData('rights', $this->rights); ?>
<?php if ($this->metakey)
    Factory::getContainer()->get(ApplicationInterface::class)->getDocument()->setMetaData('keywords', $this->metakey); ?>
<?php if ($this->metadesc)
    Factory::getContainer()->get(ApplicationInterface::class)->getDocument()->setMetaData('description', $this->metadesc); ?>
<?php if ($this->xreference)
    Factory::getContainer()->get(ApplicationInterface::class)->getDocument()->setMetaData('xreference', $this->xreference); ?>
