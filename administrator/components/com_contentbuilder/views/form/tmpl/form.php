        ...
        <td valign="top">
            ...
            for ($i=0; $i < $n; $i++)
            {
                ...
                <tr class="<?php echo "row$k"; ?>">
                    ...
                    <td valign="top">
                        <input class="form-control form-control-sm w-100" type="text" style="width: 20px;" name="itemWordwrap[<?php echo $row->id ?>]" value="<?php echo htmlentities($row->wordwrap, ENT_QUOTES, 'UTF-8')?>"/>
                    </td>
                    <td valign="top">
                        <input class="form-control form-control-sm w-100" style="width: 150px;" type="text" name="itemWrapper[<?php echo $row->id ?>]" value="<?php echo htmlentities($row->item_wrapper, ENT_QUOTES, 'UTF-8')?>"/>
                    </td>
                    <td valign="top">
                    <?php echo $published;?>
                    </td>
                    <td class="order" width="150" valign="top">
                        ...
                        <input type="hidden" name="order[]" size="5" style="width: 20px;" value="<?php echo $row->ordering; ?>" <?php echo $disabled ?> class="text_area" style="text-align: center" />
                    </td>
                </tr>
                <?php
                $k = 1 - $k;
...
?>
    <tr class="<?php echo "row$k"; ?>">
                <td>
                    <input class="form-check-input" type="checkbox" name="list_states[<?php echo $state['id'];?>][published]" value="1"<?php echo $state['published'] ? ' checked="checked"' : ''?>/>
                </td>
                <td>
                    <input class="form-control form-control-sm w-100" type="text" name="list_states[<?php echo $state['id'];?>][title]" value="<?php echo htmlentities($state['title'], ENT_QUOTES, 'UTF-8');?>"/>
                </td>
                <td>
                    <input class="form-control form-control-sm w-100 color" type="text" value="<?php echo $state['color'];?>" name="list_states[<?php echo $state['id'];?>][color]"/><br/>
                </td>
                <td>
...
<table width="100%" class="adminform table table-striped">
    ...
    <tr>
        ...
        <td>
            ...
            if($this->form->edit_by_type && $this->form->type == 'com_breezingforms'){
            ?>
            <input class="form-check-input" type="checkbox" value="1" name="protect_upload_directory" id="protect_upload_directory"<?php echo trim($this->form->protect_upload_directory) ? ' checked="checked"' : ''; ?>/>
            <?php
            }
            ?>
        </td>
...
<table class="adminlist table table-striped">
    ...
    <tr class="row0">
        ...
        <td>
            <input class="form-check-input" type="checkbox" name="limited_article_options_fe" id="limited_article_options_fe" value="1"<?php echo $this->form->limited_article_options_fe ? ' checked="checked"' : '';?>/>
        </td>
    </tr>
    <tr class="row0">
        <td width="20%" align="right" class="key">
    ...
    <tr class="row0">
        ...
        <td>
            <input class="form-check-input" type="checkbox" name="show_all_languages_fe" id="show_all_languages_fe" value="1"<?php echo $this->form->show_all_languages_fe ? ' checked="checked"' : '';?>/>
        </td>
    </tr>
    <?php
    if($this->form->edit_by_type){
...
<table class="adminlist table table-striped">
            ...
            <tr>
                <td style="background-color: #F0F0F0"></td>
                <td style="background-color: #F0F0F0"><input class="form-check-input" type="checkbox" onclick="contentbuilder_selectAll(this,'fe')" value="listaccess"/></td>
                <td style="background-color: #F0F0F0"><input class="form-check-input" type="checkbox" onclick="contentbuilder_selectAll(this,'fe')" value="view"/></td>
                <td style="background-color: #F0F0F0"><input class="form-check-input" type="checkbox" onclick="contentbuilder_selectAll(this,'fe')" value="new"/></td>
                <td style="background-color: #F0F0F0"><input class="form-check-input" type="checkbox" onclick="contentbuilder_selectAll(this,'fe')" value="edit"/></td>
                <td style="background-color: #F0F0F0"><input class="form-check-input" type="checkbox" onclick="contentbuilder_selectAll(this,'fe')" value="delete"/></td>
                <td style="background-color: #F0F0F0"><input class="form-check-input" type="checkbox" onclick="contentbuilder_selectAll(this,'fe')" value="state"/></td>
                <td style="background-color: #F0F0F0"><input class="form-check-input" type="checkbox" onclick="contentbuilder_selectAll(this,'fe')" value="publish"/></td>
                <td style="background-color: #F0F0F0"><input class="form-check-input" type="checkbox" onclick="contentbuilder_selectAll(this,'fe')" value="fullarticle"/></td>
                <td style="background-color: #F0F0F0"><input class="form-check-input" type="checkbox" onclick="contentbuilder_selectAll(this,'fe')" value="language"/></td>
                <td style="background-color: #F0F0F0"><input class="form-check-input" type="checkbox" onclick="contentbuilder_selectAll(this,'fe')" value="rating"/></td>
            </tr>
...
?>
            <tr class="<?php echo "row$k"; ?>">
                ...
                <td><input class="form-check-input" type="checkbox" name="perms_fe[<?php echo $entry->value; ?>][listaccess]" value="1"<?php echo !$this->form->id ? ' checked="checked"' : ( isset($this->form->config['permissions_fe']) && isset($this->form->config['permissions_fe'][$entry->value]) && isset($this->form->config['permissions_fe'][$entry->value]['listaccess']) && $this->form->config['permissions_fe'][$entry->value]['listaccess'] ? ' checked="checked"' : '' );?>/></td>
                <td><input class="form-check-input" type="checkbox" name="perms_fe[<?php echo $entry->value; ?>][view]" value="1"<?php echo !$this->form->id ? ' checked="checked"' : ( isset($this->form->config['permissions_fe']) && isset($this->form->config['permissions_fe'][$entry->value]) && isset($this->form->config['permissions_fe'][$entry->value]['view']) && $this->form->config['permissions_fe'][$entry->value]['view'] ? ' checked="checked"' : '' );?>/></td>
                <td><input class="form-check-input" type="checkbox" name="perms_fe[<?php echo $entry->value; ?>][new]" value="1"<?php echo isset($this->form->config['permissions_fe']) && isset($this->form->config['permissions_fe'][$entry->value]) && isset($this->form->config['permissions_fe'][$entry->value]['new']) && $this->form->config['permissions_fe'][$entry->value]['new'] ? ' checked="checked"' : '';?>/></td>
                <td><input class="form-check-input" type="checkbox" name="perms_fe[<?php echo $entry->value; ?>][edit]" value="1"<?php echo isset($this->form->config['permissions_fe']) && isset($this->form->config['permissions_fe'][$entry->value]) && isset($this->form->config['permissions_fe'][$entry->value]['edit']) && $this->form->config['permissions_fe'][$entry->value]['edit'] ? ' checked="checked"' : '';?>/></td>
                <td><input class="form-check-input" type="checkbox" name="perms_fe[<?php echo $entry->value; ?>][delete]" value="1"<?php echo isset($this->form->config['permissions_fe']) && isset($this->form->config['permissions_fe'][$entry->value]) && isset($this->form->config['permissions_fe'][$entry->value]['delete']) && $this->form->config['permissions_fe'][$entry->value]['delete'] ? ' checked="checked"' : '';?>/></td>
                <td><input class="form-check-input" type="checkbox" name="perms_fe[<?php echo $entry->value; ?>][state]" value="1"<?php echo isset($this->form->config['permissions_fe']) && isset($this->form->config['permissions_fe'][$entry->value]) && isset($this->form->config['permissions_fe'][$entry->value]['state']) && $this->form->config['permissions_fe'][$entry->value]['state'] ? ' checked="checked"' : '';?>/></td>
                <td><input class="form-check-input" type="checkbox" name="perms_fe[<?php echo $entry->value; ?>][publish]" value="1"<?php echo isset($this->form->config['permissions_fe']) && isset($this->form->config['permissions_fe'][$entry->value]) && isset($this->form->config['permissions_fe'][$entry->value]['publish']) && $this->form->config['permissions_fe'][$entry->value]['publish'] ? ' checked="checked"' : '';?>/></td>
                <td><input class="form-check-input" type="checkbox" name="perms_fe[<?php echo $entry->value; ?>][fullarticle]" value="1"<?php echo isset($this->form->config['permissions_fe']) && isset($this->form->config['permissions_fe'][$entry->value]) && isset($this->form->config['permissions_fe'][$entry->value]['fullarticle']) && $this->form->config['permissions_fe'][$entry->value]['fullarticle'] ? ' checked="checked"' : '';?>/></td>
                <td><input class="form-check-input" type="checkbox" name="perms_fe[<?php echo $entry->value; ?>][language]" value="1"<?php echo isset($this->form->config['permissions_fe']) && isset($this->form->config['permissions_fe'][$entry->value]) && isset($this->form->config['permissions_fe'][$entry->value]['language']) && $this->form->config['permissions_fe'][$entry->value]['language'] ? ' checked="checked"' : '';?>/></td>
                <td><input class="form-check-input" type="checkbox" name="perms_fe[<?php echo $entry->value; ?>][rating]" value="1"<?php echo isset($this->form->config['permissions_fe']) && isset($this->form->config['permissions_fe'][$entry->value]) && isset($this->form->config['permissions_fe'][$entry->value]['rating']) && $this->form->config['permissions_fe'][$entry->value]['rating'] ? ' checked="checked"' : '';?>/></td>
            </tr>       
<?php
    $k = 1 - $k;
}
