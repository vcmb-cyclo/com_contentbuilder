...
if (!class_exists(__NAMESPACE__ . '\\CBRequest'))
{
	...
	class CBRequest
	{
		...
		{
			// Cast to string, in case CBREQUEST_ALLOWRAW was specified for mask
		...
		public static function setVar($name, $value = null, $hash = 'method', $overwrite = true)
		{
			...
			$GLOBALS['_CBREQUEST'][$name]['SET.' . $hash] = true;
			$GLOBALS['_CBREQUEST'][$name]['SET.REQUEST'] = true;
